...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Edit Type: {{$type->name}}</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <form class="form-horizontal" method="post" action="{{url('admin/edit-type/'.$type->id)}}">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <!-- <option value="{{$type->idCatelogy}}">{{$type->catelogy->name}}</option> -->
                                @foreach($catelogy as $catelogy)
                                <option value="{{$catelogy->id}}" @if($catelogy->id == $type->idCatelogy) selected @endif > {{$catelogy->name}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
